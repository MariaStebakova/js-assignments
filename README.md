...
## Javascript Assignments  [![Build Status](https://travis-ci.org/MariaStebakova/js-assignments.svg?branch=master)](https://travis-ci.org/MariaStebakova/js-assignments)
